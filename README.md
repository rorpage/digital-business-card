...
- **Edit mode** - input cards for name, email, phone, personal website, company website, LinkedIn, GitHub, and address; all fields saved to `localStorage` on every keystroke
